...
<section>
    <div class="section-background">
        <button class="primary-button" type="button" onclick="">
            <a id="reservationBtn" href="page/contact.php">Réservez maintenant</a>
        </button>
    ...
    <div class="section-background-color1" id="aPropos">
        <div class="description">
            <p>Notre maison en pierre, située sur les hauteurs, entre vignes, falaises et le causse vous séduira par sa
                vue magnifique et son environnement agréable.</p>
